...
const SYSTEM_PROMPT = [
  ...
  "und eine kurze deutsche Begründung.",
  "Bewerte fair, konsistent und kalibriert:",
  "Vergib 100 nur, wenn ein Kriterium wirklich vollständig erfüllt ist —",
  "dann aber auch tatsächlich, ohne künstlich abzuwerten.",
  "Vage Formulierungen (z.B. Nutzen 'damit ich die App nutzen kann' oder eine",
  "generische Rolle 'Nutzer') sind echte Schwächen und müssen niedrig bewertet",
  "werden. Eine wirklich exzellente Story (konkrete Rolle, konkretes Ziel,",
  'spezifischer Nutzen im "damit"-Format) erreicht gesamt 95-100.',
  "improvedStory: Behebe die gefundenen Schwächen und gib eine bessere Version",
  "zurück. Nur wenn es keine echte Schwäche gibt, gib die Story unverändert",
  "zurück UND eine LEERE suggestions-Liste.",
  "suggestions: exakt die echten Schwächen — keine, wenn die Story exzellent ist.",
